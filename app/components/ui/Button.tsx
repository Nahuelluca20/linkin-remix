...
const button = tv({
  ...
  variants: {
    ...
    isDisabled: {
      true: "cursor-not-allowed bg-gray-100 dark:bg-zinc-800 text-gray-300 dark:text-zinc-600 forced-colors:text-[GrayText] border-black/5 dark:border-white/5 hover:bg-gray-100 dark:hover:bg-zinc-800",
    },
  },
  defaultVariants: {
    variant: "primary",
